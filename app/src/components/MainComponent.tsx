...
function MainComponent({회원관리, openModal, isTimerHp, timerStopHp}) {
   ...
   const onChangeServiceCheckAll=(e: ChangeEvent<HTMLInputElement>)=>{
      let imsi: Array<any> = [];
      const checkService = document.getElementsByClassName('check-service'); //체크박스 7개의 공통 선택자

      if( e.target.checked ){
         // for(let i=0; i<checkService.length; i++){
         //    imsi = [...imsi, checkService[i].value]
         // }      
